...
class SecurityHeaders
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        if (!app()->environment('testing')) {
            ...
            $response->headers->set('Content-Security-Policy', "default-src 'self'; script-src 'self' https://cdnjs.cloudflare.com cdn.datatables.net cdn.jsdelivr.net code.jquery.com www.google-analytics.com  www.googletagmanager.com 'unsafe-inline' 'unsafe-eval'; style-src 'self' cdn.datatables.net cdnjs.cloudflare.com cdn.jsdelivr.net fonts.googleapis.com 'unsafe-inline'; img-src 'self' * data:; font-src 'self' fonts.gstatic.com cdnjs.cloudflare.com data: ; connect-src 'self' www.google-analytics.com ; media-src 'self'; frame-src 'self' www.google.com; object-src 'none'; base-uri 'self'; report-uri ");
