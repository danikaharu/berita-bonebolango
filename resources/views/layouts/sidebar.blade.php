    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="/"><img src="{{ asset('mazer') }}/images/logo/logo2.svg" alt="Logo"
                            srcset=""></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                            ...
                            @foreach ($sidebar['menus'] as $menu)
                                ...
                                @canany($permissions)
                                    @if (empty($menu['submenus']))
                                        @can($menu['permission'])
                                            <li
                                                class="sidebar-item{{ \App\Generators\GeneratorUtils::isActiveMenu($menu['route']) }}">
                                                <a href="{{ route($menu['route'] . '.index') }}" class="sidebar-link">
                                                    {!! $menu['icon'] !!}
                                    ...
                                    @else
                                        <li
                                            class="sidebar-item has-sub{{ \App\Generators\GeneratorUtils::isActiveMenu($menu['permissions']) }}">
                ...
                <li class="sidebar-item{{ request()->is('admin/statistic') ? ' active' : '' }}">
                    <a class="sidebar-link" href="{{ route('statistic') }}">
